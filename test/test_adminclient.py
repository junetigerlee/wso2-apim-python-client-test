...
wso2_apim_adminclient.configuration.host = 'https://localhost:9443/api/am/admin/v0.11'
wso2_apim_adminclient.configuration.verify_ssl =False
# Configure OAuth2 access token for authorization: OAuth2
wso2_apim_adminclient.configuration.access_token = '68e32451-e8bb-3742-a8a3-1b5b6d382367'
